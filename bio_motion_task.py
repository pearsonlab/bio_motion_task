...
def play_through_movies(win, files, timing, keymap, choice, participant, delay, round, trigger):
    ...
    routes = [[33, 21, 24, 23, 20,  3, 31,  8, 32, 16,  5, 29, 34, 14,  0, 15, 27,
                11, 19, 22,  4, 18,  1, 26, 25, 28,  6, 12,  2, 30,  7, 13,  9, 10, 17, 35],
              [ 24, 27, 22, 8,  9,  3,  17, 12,  6, 26, 32, 15, 13,  1,  2, 19, 29,
                33, 21, 31, 34,  0, 20,  5, 10, 14, 23, 35, 18,  4,  7, 16, 25, 30, 11, 28],
              [30, 15,  0,   4,  3, 21, 32, 26,  6, 34, 14, 11, 19, 27, 31, 33, 16,
